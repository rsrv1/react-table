...
function RowSelectionCountBadge() {
    ...
    return (
        <span className="absolute top-4 left-0 bg-indigo-50 h-[1.20rem] w-4 md:w-5 flex items-center px-1 text-[0.70rem] text-indigo-700 border border-r-transparent border-indigo-400">
            {rowSelectionCount}
        </span>
    )
}
